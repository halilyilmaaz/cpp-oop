...
class Nokta{
	private:
		int x;
		int y;
		static int i; // static özelliklerin get ve set methodlarý da static olmalý(ayrýca burada baslangic degeri veremeyiz.Bunu vermenin yolu sýnýftan cýkýp int Nokta::i=0; demektir) )
	protected:
